...
class AppConfigController {
  ...
  /// Re-fetch config — use for pull-to-refresh or retry after failure.
  Future<void> reload() => load();

  /// Called from AuthBuilder on logout.
  /// Clears handlers so stale custom routes don't persist into the next session.
  /// resetAllAtoms() handles resetting the atom itself.
  void onLogout() => AppNavigator.clearHandlers();
}
